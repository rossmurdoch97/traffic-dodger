...
#define WINDOW_TITLE "Drive Time"
...
enum gameState {EXIT, MENU, INSTRUCTIONS, PLAYING, HIGHSCORE, YOUSURE, SAVING, RESTART, ENDGAME,COLLIDE};
enum btntype {QUIT, PLAY, SAVE, CONTROLS};
#endif